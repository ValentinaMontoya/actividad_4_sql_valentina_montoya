...
CREATE TABLE IF NOT EXISTS `cities_countries_continents` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
  `cities_id` smallint(6) NOT NULL DEFAULT 0,
  `countries_id` smallint(6) NOT NULL DEFAULT 0,
  `continents_id` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `cities_countries_continents` (`id`, `cities_id`, `countries_id`, `continents_id`) VALUES
	(1, 1, 1, 1),
	(2, 2, 6, 1),
	(3, 3, 5, 1),
	(4, 4, 2, 1),
